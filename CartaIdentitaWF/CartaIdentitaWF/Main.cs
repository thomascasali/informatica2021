...
namespace CartaIdentitaWF
{
    public partial class Main : Form
    {
        ...
        private void cbComuneNascita_TextUpdate(object sender, EventArgs e)
        {           
            List<Comune> comunifiltered=new List<Comune>();
            comunifiltered = comuni.Where(c => c.Nome.Contains(((ComboBox)sender).Text)).ToList();
            cbComuneNascita.DataSource = null;
            cbComuneNascita.DataSource = comunifiltered;
            cbComuneNascita.DisplayMember = "Nome";
            cbComuneNascita.ValueMember = "Self";
        }

        private void cbComuneNascita_SelectedIndexChanged(object sender, EventArgs e)
        {
