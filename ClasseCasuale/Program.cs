    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do {
                ...
                Console.WriteLine("Numero casuale tra 0 e 150: " + c.Estrai(150));
                Console.WriteLine("Numero casuale tra 10 e 150: " + c.Estrai(10, 150));
                Console.ReadKey();

                CasualePari cp = new CasualePari();
                Console.WriteLine("\nNumero casuale pari: " + cp.Estrai());
                Console.WriteLine("Numero casuale pari tra 0 e 150: " + cp.Estrai(150));
                Console.WriteLine("Numero casuale pari tra 10 e 150: " + cp.Estrai(10, 150));
                Console.ReadKey();

                CasualeDispari cd = new CasualeDispari();
                Console.WriteLine("\nNumero casuale dispari: " + cd.Estrai());
                Console.WriteLine("Numero casuale dispari tra 0 e 150: " + cd.Estrai(150));
                Console.WriteLine("Numero casuale dispari tra 10 e 150: " + cd.Estrai(10, 150));
                Console.ReadKey();

                CasualePrimo cprimo = new CasualePrimo();
                Console.WriteLine("\nNumero casuale primo: " + cprimo.Estrai());
                Console.WriteLine("Numero casuale primo tra 0 e 150: " + cprimo.Estrai(150));
                Console.WriteLine("Numero casuale primo tra 10 e 150: " + cprimo.Estrai(10, 150));
                Console.WriteLine();
